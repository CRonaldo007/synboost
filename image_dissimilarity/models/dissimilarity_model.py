...
from image_dissimilarity.models.vgg_features import VGGFeatures, VGGSPADE, VGG19_difference
...
class DissimNetPrior19(nn.Module):
    def __init__(self, architecture='vgg19', semantic=True, pretrained=True, correlation=True, prior=False, spade='',
                 num_semantic_classes=19):
        super(DissimNetPrior, self).__init__()
        ...
        if self.spade == 'encoder' or self.spade == 'both':
            ...
            self.vgg_encoder = VGG19_difference(architecture=architecture, pretrained=pretrained)
